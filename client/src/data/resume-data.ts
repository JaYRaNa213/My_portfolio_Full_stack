export const resumeData = {
  ...
  highlights: [
    ...
    { title: "AI Integration", icon: "robot" },
    { title: "Automation Workflows", icon: "settings" },
    { title: "Continuous Learning", icon: "graduation" }
  ],
  ...
  projects: [
    {
      ...
      image: "https://res.cloudinary.com/djtq2eywl/image/upload/v1758038845/Screenshot_1201_vicizu.png",
  ...
  image: "https://res.cloudinary.com/dzg1bmddg/image/upload/v1781861946/wwobnps8ncjromsfq231.png",
  ...
  careerGoals: [
    {
      ...
      description: "Seeking internships in web development with focus on React.js and Node.js",
      icon: "target"
    },
    {
      title: "AI Developer",
      description: "Interested in AI integration and automation workflow development",
      icon: "robot"
    },
    {
